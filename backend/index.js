...
// Mongodb connection
mongoose.connect("mongodb+srv://arunchauhan:arun1806@cluster0.4b6bfxg.mongodb.net/SHOOPER-BACKEND").then(()=> {console.log("Mongodb Connected")}).catch((error)=>console.log(error))
